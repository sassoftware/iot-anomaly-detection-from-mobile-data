...
function M:newUI( options )
	...
	barContainer.x = display.safeScreenOriginX  +200
	barContainer.y = display.safeScreenOriginY  + 200
	...
	local sampleCodeTitle = options.title or "IoT Demo"
	local buildNum
	...
	local background = display.newImageRect( backGroup, "pictures/back-" .. themeName .. ".png", 360, 640 )
	...
	local infoButton = display.newImageRect( barContainer, "pictures/infobutton.png", 25, 25 )
	...
	local function onResize( event )
		...
		barContainer.y = display.safeScreenOriginY - 5
